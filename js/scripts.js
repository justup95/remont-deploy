...
//   // var preview = document.querySelectorAll('.portfolio__gallery-preview');

//   // var play = videos + preview; 
...
if (animItems.length > 0) {
  ...
  function animOnScroll() {
    for (let index = 0; index < animItems.length; index++) {
      ...
      if(animItemHeight > window.animItemHeight){
        animItemPoint = window.innerHeight - animItemHeight / animStart;
      }

      if ((pageYOffset > animItemOffset - animItemPoint) && scrollY < (animItemOffset + animItemHeight)) {
